...
<html lang="en">
    ...
    <head>
        ...
        <meta name="website" content="/home" />
        <meta name="Version" content="v1.2.0" />
        <!-- favicon -->
        <link rel="shortcut icon" href="/assets/images/subject-details/favicon.ico.png">
        <!-- Bootstrap -->
        <link href="/assets/css/subject-details/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- simplebar -->
        <link href="/assets/css/subject-details/simplebar.css" rel="stylesheet" type="text/css" />
        <!-- SLIDER -->
        <link href="/assets/css/subject-details/tiny-slider.css" rel="stylesheet" />
        <!-- Icons -->
        <link href="/assets/css/subject-details/materialdesignicons.min.css" rel="stylesheet" type="text/css" />
        <link href="/assets/css/subject-details/remixicon.css" rel="stylesheet" type="text/css" />
        <link href="https://unicons.iconscout.com/release/v3.0.6/css/line.css"  rel="stylesheet">
        <!-- Css -->
        <link href="/assets/css/subject-details/style.min.css" rel="stylesheet" type="text/css" id="theme-opt" />
    ...
    <body>
            ...
            <nav id="sidebar" class="sidebar-wrapper">
                <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                    <div class="sidebar-brand">
                        <a href="index.html">
                            <img src="/assets/images/subject-details/logo-dark.png" height="24" class="logo-light-mode" alt="">
                            <img src="/assets/images/subject-details/logo-light.png" height="24" class="logo-dark-mode" alt="">
                        </a>
                    </div>
                    ...
                    <div class="header-bar d-flex justify-content-between border-bottom">
                        <div class="d-flex align-items-center">
                            <a href="#" class="logo-icon">
                                <img src="/assets/images/subject-details/logo-icon.png" height="30" class="small" alt="">
                                <span class="big">
                                    <img src="/assets/images/subject-details/logo-dark.png" height="24" class="logo-light-mode" alt="">
                                    <img src="/assets/images/subject-details/logo-light.png" height="24" class="logo-dark-mode" alt="">
                                </span>
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="list-inline-item mb-0">
                                <div class="dropdown dropdown-primary">
                                    <button type="button" class="btn btn-pills btn-soft-primary dropdown-toggle p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/assets/images/subject-details/language/american.png" class="avatar avatar-ex-small rounded-circle p-2" alt=""></button>
                                    <div class="dropdown-menu dd-menu drop-ups dropdown-menu-end bg-white shadow border-0 mt-3 p-2" data-simplebar style="height: 175px;">
                                        <a href="javascript:void(0)" class="d-flex align-items-center">
                                            <img src="/assets/images/subject-details/language/chinese.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                            <img src="/assets/images/subject-details/language/european.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                            <div class="flex-1 text-left ms-2 overflow-hidden">
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                            <img src="/assets/images/subject-details/language/indian.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                            <div class="flex-1 text-left ms-2 overflow-hidden">
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                            <img src="/assets/images/subject-details/language/japanese.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                            <div class="flex-1 text-left ms-2 overflow-hidden">
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                            <img src="/assets/images/subject-details/language/russian.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                            <div class="flex-1 text-left ms-2 overflow-hidden">
                                    ...
                                    <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow rounded border-0 mt-3 px-2 py-2" data-simplebar style="height: 320px; width: 300px;">
                                        <a href="#" class="d-flex align-items-center justify-content-between py-2">
                                            <div class="d-inline-flex position-relative overflow-hidden">
                                                <img src="/assets/images/subject-details/client/02.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                        ...
                                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                                            <div class="d-inline-flex position-relative overflow-hidden">
                                                <img src="/assets/images/subject-details/client/Codepen.svg" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                        ...
                                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                                            <div class="d-inline-flex position-relative overflow-hidden">
                                                <img src="/assets/images/subject-details/client/03.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                        ...
                                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                                            <div class="d-inline-flex position-relative overflow-hidden">
                                                <img src="/assets/images/subject-details/client/dribbble.svg" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                        ...
                                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                                            <div class="d-inline-flex position-relative overflow-hidden">
                                                <img src="/assets/images/subject-details/client/06.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                        ...
                                        <a href="#" class="d-flex align-items-center justify-content-between py-2 border-top">
                                            <div class="d-inline-flex position-relative overflow-hidden">
                                                <img src="/assets/images/subject-details/client/07.jpg" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                            ...
                            <li class="list-inline-item mb-0 ms-1">
                                <div class="dropdown dropdown-primary">
                                    <button type="button" class="btn btn-pills btn-soft-primary dropdown-toggle p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/assets/images/subject-details/doctors/01.jpg" class="avatar avatar-ex-small rounded-circle" alt=""></button>
                                    <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow border-0 mt-3 py-3" style="min-width: 200px;">
                                        <a class="dropdown-item d-flex align-items-center text-dark" href="https://shreethemes.in/doctris/layouts/admin/profile.html">
                                            <img src="/assets/images/subject-details/doctors/01.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                    ...
                    <div class="layout-specing">
                        ...
                        <div class="card bg-white rounded shadow overflow-hidden mt-4 border-0">
                            ...
                            <div class="avatar-profile d-flex margin-nagative mt-n5 position-relative ps-3">
                                <img src="/assets/images/subject-details/doctors/01.jpg" class="rounded-circle shadow-md avatar avatar-medium" alt="">
                                            ...
                                            <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="overview-tab">
                                                ...
                                                <div class="row row-cols-md-2 row-cols-lg-5">
                                                    <div class="col mt-4">
                                                        <div class="card team border-0 rounded shadow overflow-hidden">
                                                            <div class="team-person position-relative overflow-hidden">
                                                                <img src="/assets/images/subject-details/doctors/05.jpg" class="img-fluid" alt="">
                                                    ...
                                                    <div class="col mt-4">
                                                        <div class="card team border-0 rounded shadow overflow-hidden">
                                                            <div class="team-person position-relative overflow-hidden">
                                                                <img src="/assets/images/subject-details/doctors/06.jpg" class="img-fluid" alt="">
                                                                <ul class="list-unstyled team-like">
                                                                    <li><a href="#" class="btn btn-icon btn-pills btn-soft-danger"><i data-feather="heart" class="icons"></i></a></li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <div class="col mt-4">
                                                        <div class="card team border-0 rounded shadow overflow-hidden">
                                                            <div class="team-person position-relative overflow-hidden">
                                                                <img src="/assets/images/subject-details/doctors/07.jpg" class="img-fluid" alt="">
                                                                <ul class="list-unstyled team-like">
                                                                    <li><a href="#" class="btn btn-icon btn-pills btn-soft-danger"><i data-feather="heart" class="icons"></i></a></li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <div class="col mt-4">
                                                        <div class="card team border-0 rounded shadow overflow-hidden">
                                                            <div class="team-person position-relative overflow-hidden">
                                                                <img src="/assets/images/subject-details/doctors/08.jpg" class="img-fluid" alt="">
                                                                <ul class="list-unstyled team-like">
                                                                    <li><a href="#" class="btn btn-icon btn-pills btn-soft-danger"><i data-feather="heart" class="icons"></i></a></li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <div class="col mt-4">
                                                        <div class="card team border-0 rounded shadow overflow-hidden">
                                                            <div class="team-person position-relative overflow-hidden">
                                                                <img src="/assets/images/subject-details/doctors/02.jpg" class="img-fluid" alt="">
                                                                <ul class="list-unstyled team-like">
                                                                    <li><a href="#" class="btn btn-icon btn-pills btn-soft-danger"><i data-feather="heart" class="icons"></i></a></li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="pills-review" role="tabpanel" aria-labelledby="review-tab">
                                                    ...
                                                    <div class="col-lg-8 text-center">
                                                        <div class="client-review-slider">
                                                            <div class="tiny-slide text-center">
                                                                ...
                                                                <img src="/assets/images/subject-details/client/01.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow my-3" alt="">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                            ...
                                                            <div class="tiny-slide text-center">
                                                                ...
                                                                <img src="/assets/images/subject-details/client/02.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow my-3" alt="">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                            ...
                                                            <div class="tiny-slide text-center">
                                                                ...
                                                                <img src="/assets/images/subject-details/client/03.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow my-3" alt="">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                            ...
                                                            <div class="tiny-slide text-center">
                                                                ...
                                                                <img src="/assets/images/subject-details/client/04.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow my-3" alt="">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                            ...
                                                            <div class="tiny-slide text-center">
                                                                <p class="text-muted h6 fw-normal fst-italic">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. The most well-known dummy text is the 'Lorem Ipsum', which is said to have originated in the 16th century. "</p>
                                                                <img src="/assets/images/subject-details/client/05.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow my-3" alt="">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                            ...
                                                            <div class="tiny-slide text-center">
                                                                ...
                                                                <img src="/assets/images/subject-details/client/06.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow my-3" alt="">
                                                                <ul class="list-unstyled mb-0">
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                                                        <img src="/assets/images/subject-details/client/amazon.png" class="avatar avatar-client" alt="">
                                                    </div><!--end col-->
                                
                                                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                                                        <img src="/assets/images/subject-details/client/google.png" class="avatar avatar-client" alt="">
                                                    </div><!--end col-->
                                                    
                                                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                                                        <img src="/assets/images/subject-details/client/lenovo.png" class="avatar avatar-client" alt="">
                                                    </div><!--end col-->
                                                    
                                                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                                                        <img src="/assets/images/subject-details/client/paypal.png" class="avatar avatar-client" alt="">
                                                    </div><!--end col-->
                                                    
                                                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                                                        <img src="/assets/images/subject-details/client/shopify.png" class="avatar avatar-client" alt="">
                                                    </div><!--end col-->
                                                    
                                                    <div class="col-lg-2 col-md-2 col-6 text-center py-4">
                                                        <img src="/assets/images/subject-details/client/spotify.png" class="avatar avatar-client" alt="">
                                                    </div><!--end col-->
                                                </div><!--end row-->
                                            </div><!--end teb pane-->
                                                            ...
                                                            <div class="p-4">
                                                                <div class="row align-items-center">
                                                                    <div class="col-lg-2 col-md-4">
                                                                        <img src="/assets/images/subject-details/doctors/01.jpg" class="avatar avatar-md-md rounded-pill shadow mx-auto d-block" alt="">
                                                                    </div><!--end col-->
        ...
        <div class="offcanvas offcanvas-end bg-white shadow" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
            <div class="offcanvas-header p-4 border-bottom">
                <h5 id="offcanvasRightLabel" class="mb-0">
                    <img src="/assets/images/subject-details/logo-dark.png" height="24" class="light-version" alt="">
                    <img src="/assets/images/subject-details/logo-light.png" height="24" class="dark-version" alt="">
                </h5>
                        ...
                        <div id="style-switcher">
                            <div>
                                <ul class="text-center list-unstyled mb-0">
                                    <li class="d-grid"><a href="javascript:void(0)" class="rtl-version t-rtl-light" onclick="setTheme('style-rtl')"><img src="/assets/images/subject-details/layouts/light-dash-rtl.png" class="img-fluid rounded-md shadow-md d-block" alt=""><span class="text-muted mt-2 d-block">RTL Version</span></a></li>
                                    <li class="d-grid"><a href="javascript:void(0)" class="ltr-version t-ltr-light" onclick="setTheme('style')"><img src="/assets/images/subject-details/layouts/light-dash.png" class="img-fluid rounded-md shadow-md d-block" alt=""><span class="text-muted mt-2 d-block">LTR Version</span></a></li>
                                    <li class="d-grid"><a href="javascript:void(0)" class="dark-rtl-version t-rtl-dark" onclick="setTheme('style-dark-rtl')"><img src="/assets/images/subject-details/layouts/dark-dash-rtl.png" class="img-fluid rounded-md shadow-md d-block" alt=""><span class="text-muted mt-2 d-block">RTL Version</span></a></li>
                                    <li class="d-grid"><a href="javascript:void(0)" class="dark-ltr-version t-ltr-dark" onclick="setTheme('style-dark')"><img src="/assets/images/subject-details/layouts/dark-dash.png" class="img-fluid rounded-md shadow-md d-block" alt=""><span class="text-muted mt-2 d-block">LTR Version</span></a></li>
                                    <li class="d-grid"><a href="javascript:void(0)" class="dark-version t-dark mt-4" onclick="setTheme('style-dark')"><img src="/assets/images/subject-details/layouts/dark-dash.png" class="img-fluid rounded-md shadow-md d-block" alt=""><span class="text-muted mt-2 d-block">Dark Version</span></a></li>
                                    <li class="d-grid"><a href="javascript:void(0)" class="light-version t-light mt-4" onclick="setTheme('style')"><img src="/assets/images/subject-details/layouts/light-dash.png" class="img-fluid rounded-md shadow-md d-block" alt=""><span class="text-muted mt-2 d-block">Light Version</span></a></li>
                                    <li class="d-grid"><a href="../landing/index.html" target="_blank" class="mt-4"><img src="/assets/images/subject-details/layouts/landing-light.png" class="img-fluid rounded-md shadow-md d-block" alt=""><span class="text-muted mt-2 d-block">Landing Demos</span></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- end Style switcher -->
        ...
        <!-- javascript -->
        <script src="/assets/js/subject-details/bootstrap.bundle.min.js"></script>
        <!-- simplebar -->
        <script src="/assets/js/subject-details/simplebar.min.js"></script>
        <!-- SLIDER -->
        <script src="/assets/js/subject-details/tiny-slider.js"></script>
        <script src="/assets/js/subject-details/tiny-slider-init.js"></script>
        <!-- Icons -->
        <script src="/assets/js/subject-details/feather.min.js"></script>
        <!-- Main Js -->
        <script src="/assets/js/subject-details/app.js"></script>
