                    ...
                    <div class="row">
                            ...
                            <div class="widget courses-search-bx placeani">
                                <div class="form-group">
                                    <div class="input-group">
                                        <form action="${pageContext.request.contextPath}/my-course/search" method="get">
                                            <div class="input-group">
                            ...
                            <div class="widget widget_archive">
                                ...
                                <ul>
                                    ...
                                    <c:if test="${not empty subjectSet}">
                                        <li><a href="${pageContext.request.contextPath}/my-course">General</a></li>
                                        <c:forEach items="${subjectSet}" var="sub">
                                            <li>
                                                <a href="${pageContext.request.contextPath}/my-course/search?courseSearch=${param.courseSearch}&subjectId=${sub.id}">${sub.name}- ${sub.code}</a>
                                            </li>
                                        </c:forEach>
                                    </c:if>
                                </ul>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-12">
                            <div class="row">
                                ...
                                <c:if test="${not empty myCourseList}">
