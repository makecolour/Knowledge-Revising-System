                ...
                <div class="widget-box">
                    ...
                    <div class="widget-inner">
                        <form class="edit-profile m-b30" method="post"
                              action="${pageContext.request.contextPath}/course-adding">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ml-auto">
                                        <h3>1. Basic info</h3>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <input class="form-control" type="text" value="${sessionScope.name}"
                                               name="courseName">
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <c:if test="${not empty teacherList}">
                                            ...
                                            <select class="form-control" name="teacher">
                                                <option value="${thisManager.id}">${thisManager.fullName}
                                                    - ${thisManager.id}</option>
