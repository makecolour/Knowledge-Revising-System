        ...
        <div class="row">
            ...
            <div class="col-lg-12 m-b30">
                <div class="widget-box">
                    <div class="wc-title">
                        <h2 class="title-head">Course Detail - ${course.courseName}</h2>
                    </div>
                    <div class="widget-inner">
                        <form class="edit-profile m-b30" method="post" action="/course-admin/edit/${course.id}">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ml-auto">
                                        <h3>1. Basic info</h3>
                                    ...
                                    <div>
                                        <c:if test="${not empty subjectSet}">
                                            <select name="subjectId" id="subject">
                                                <option value="${course.subject.id}">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <c:if test="${not empty teacherSet}">
                                            <select name="teacher" id="teacher">
                                                <option value="${course.teacher.id}">
                                                        ${course.teacher.fullName} - ${course.teacher.id}
                                                </option>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <c:if test="${not empty semesterSet}">
                                            <select name="semesterId" id="semester">
                                                <option value="${course.role.id}">
                                                        ${course.role.name}
                                                </option>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div>
                                        <input type="radio" id="status-active" name="status"
                                               value="true" ${course.status ? 'checked' : ''}>
                                        <label for="status-active">Active</label>
                                    </div>
                                    <div>
                                        <input type="radio" id="status-inactive" name="status"
                                               value="false" ${!course.status ? 'checked' : ''}>
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="${pageContext.request.contextPath}/course-admin" class="btn btn-danger">Cancel</a>
