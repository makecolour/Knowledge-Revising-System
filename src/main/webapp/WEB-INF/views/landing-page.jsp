                                    ...
                                    <div class="item">
                                        <div class="cours-bx">
                                            <div class="action-box">
                                                ...
                                                <a href="course/detail/${course.id}" class="btn">Read More</a>
                                            </div>
                                            <div class="info-bx text-center">
                                                <h5>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center text-white">
                            ...
                            <form action="${pageContext.request.contextPath}/course" method="get" class="cours-search">

                                <div class="input-group" style="display: flex; flex-direction: row">
                                    <input name="courseSearch" placeholder="What do you want to learn today?	"
