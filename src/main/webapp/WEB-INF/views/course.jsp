                                    ...
                                    <div class="input-group">
                                        <form action="${pageContext.request.contextPath}/course/search" method="get">
                                            <div class="input-group">
                                                ...
                                                <input name="courseSearch" type="text" class="form-control"
                                                       value="${sessionScope.courseSearch}">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div aria-label="Page navigation">
                                <ul class="pagination">
                                    <c:if test="${currentPage > 0}">
                                        <li class="page-item">
                                            <a class="page-link" href="${pageContext.request.contextPath}/course/search?courseSearch=${param.courseSearch}&subjectId=${param.subjectId}&page=${currentPage - 1}&size=${9}">Previous</a>
                                        </li>
                                    </c:if>
                                    <c:if test="${totalPages > 0}">
                                        <c:forEach var="i" begin="0" end="${totalPages - 1}">
                                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                                <a class="page-link" href="${pageContext.request.contextPath}/course/search?courseSearch=${param.courseSearch}&subjectId=${param.subjectId}&page=${i}&size=${9}">${i+1}</a>
                                            </li>
                                        </c:forEach>
                                    </c:if>
                                    <c:if test="${currentPage < totalPages - 1}">
                                        <li class="page-item">
                                            <a class="page-link" href="${pageContext.request.contextPath}/course/search?courseSearch=${param.courseSearch}&subjectId=${param.subjectId}&page=${currentPage + 1}&size=${9}">Next</a>
                                        </li>
                                    </c:if>
                                </ul>
                            </div>
