...
<main class="ttr-wrapper">
    <div class="container-fluid">
        ...
        <form action="/exam/add" method="POST">
            ...
            <div>
                <label for="examLength">Length:</label>
                <input type="number" id="examLength" name="examLength" required step="5">
            </div>
            <c:forEach items="${lessons}" var="lesson" varStatus="status">
                <div>
                    <label for="lesson${status.index}">Choose a lesson:</label>
                    <select id="lesson${status.index}" name="lessonId">
                        <option value="${lesson.id}">${lesson.name}</option>
                    </select>
                    <label for="numQuestions${lesson.id}">Number of Questions:</label>
                    <input type="number" id="numQuestions${lesson.id}" name="numQuestions${lesson.id}" placeholder="Number of Questions" min="1" />
                </div>
            </c:forEach>
